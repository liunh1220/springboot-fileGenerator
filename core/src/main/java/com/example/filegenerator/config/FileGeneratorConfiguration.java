 ...
 */
@EnableWebMvc
@ComponentScan({"com.example.filegenerator"})
public class FileGeneratorConfiguration extends WebMvcConfigurerAdapter {
    private final static Logger LOGGER = LoggerFactory.getLogger(FileGeneratorConfiguration.class);
